            ...
            <div className="content-wrap">
              <Routes>
                ...
                <Route path="catalog/">
                  ...
                  <Route path="add/" element={<AddSongFormWrapper />} />
                  <Route path=":songNav/" element={<EditSong />} />
                </Route>
                <Route path="requests/">
                  <Route index element={<ArtistFacingRequestPage />} />
                  <Route path=":ownerArtist/" element={<SongRequestsPage />} />
                </Route>
